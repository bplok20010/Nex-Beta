...
define(function(require){
	...
	form.override({
		...
		labelTpl : function(d){
			...
			return ['<div id="',d.id,'_label" class="nex-form-field nex-form-field-',d.type,'"></div>'].join('');		
		},
		/*
		...
		*/
		formTpl : function(d){
			...
			text.push( '<div id="',d.id,'_trigger-body" class="nex-form-trigger-body"></div>' );
			text.push( '</div>' );
			return text.join("");	
		},
		inputTpl : function(d){
		...
		*/
		_getFormTpl : function(){
			...
			if( opt.labelPosition == 'left' || opt.labelPosition == 'top' ) {
				tpl.push(labelTpl);	
			}
			
			tpl.push(formTpl);
			
			if( opt.labelPosition == 'right' || opt.labelPosition == 'bottom' ) {
				tpl.push(labelTpl);	
			}
			
			//var tpl = self.tpl( formTpl,d );//self.formTpl(d);
