define(function(require){
	...
	var selectfield = Nex.define('Nex.form.Select','Nex.form.Trigger',{
		...
		inputTpl : function(d){
			return ['<div ',d.attrs,' id="',d.id,'_input" type="',d.type,'" autocomplete="',d.autocomplete,'" tabindex=',d.tabIndex,' value="" class="nex-form-field nex-form-field-',d.type,'"></div><input id="',d.id,'-input-real" type="hidden" value="" name="',d.name,'" />'].join('');	
		},
		sysEvents : function(){
			var self = this,
				opt = self.configs;	
